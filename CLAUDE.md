...
**Estado actual: Fase 4 — Ciclo de vida de worktrees, cerrada y mergeada en `main`** ([PR #4](https://github.com/afranco83/worktrees-manager/pull/4), `docs/ROADMAP.md`). Próxima fase: **Fase 5 — Entornos de desarrollo y logs** (arranque/parada de cada worktree, logs en tiempo real vía Socket.io). Fases 0-4 cerradas: documentación, scaffolding, modelo de datos, gestión de proyectos y ciclo de vida de worktrees (con navegación maestro-detalle, worktrees anidados, abrir terminal y ajustes globales añadidos como pulido posterior al cierre de la Fase 4 — ver `docs/ROADMAP.md` para el detalle y los ADR-0003 a ADR-0006).
...
- No adelantes trabajo de fases futuras (p. ej. no montes arranque/parada de procesos ni logs en tiempo real de la Fase 5 mientras no se pida explícitamente) salvo que el usuario lo pida explícitamente.
